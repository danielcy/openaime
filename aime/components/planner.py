...
class Planner:
    ...
    def _build_system_prompt(self, goal: str, tasks_status: str) -> str:
        ...
        return (
            ...
            "- **STRICT RULE: NEVER complete goal with pending tasks**: If there are still any pending tasks waiting to be executed, you MUST NOT choose `complete_goal`. You must either dispatch the pending tasks for execution or explicitly delete them before completing. This rule cannot be ignored under any circumstances.\n"
